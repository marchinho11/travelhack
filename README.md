...
```bash
# инициализировать poetry env и установить пакеты
make data # Подготовка данных для сервиса
make fit # Обучение ml-моделей
make build # Билд docker-images
make start # Старт микросервисов
```
