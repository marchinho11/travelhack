<img src="pic/logo.png" height="100" style="border-radius: 50%">
...
В настоящий момент на сайте tui.ru не ведется аналитика, которая могла бы позволить делать персонализированные предложения клиентам. 
На новом сайте предполагается создание сервиса, позволяющего формировать **индивидуальную выдачу/подбор** предложений для потенциального туриста.
